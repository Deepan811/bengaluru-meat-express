...
const ProductCard = ({ product }) => {
  ...
  return (
    <Card className="group hover:shadow-card-hover transition-all duration-300 transform hover:-translate-y-1 bg-gradient-card border-0 overflow-hidden">
      <Link to={`/products/${product.id}`} className="block">
        ...
        <CardContent className="p-4">
          <h3 className="font-heading font-semibold text-lg text-foreground mb-2 line-clamp-1 group-hover:text-primary transition-colors duration-200">
            {product.name}
          </h3>
      ...
      <CardFooter className="p-4 pt-0">
        <Button
          ...
          className="w-full group/btn shadow-button hover:shadow-lg transition-all duration-200"
